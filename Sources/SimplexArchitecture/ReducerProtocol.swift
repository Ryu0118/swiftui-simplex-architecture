...
public protocol ReducerProtocol<Target> {
    /// Target for the Reducer to change state, which must conform to SimplexStoreView and is automatically conformed to by the StoreBuilder or ManualStoreBuilder macros
    ...
    /// Typealias to StateContainer<Target>
