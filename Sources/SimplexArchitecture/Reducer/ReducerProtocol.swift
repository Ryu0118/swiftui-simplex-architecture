...
public protocol ReducerProtocol<Target> {
    ...
    /// Combined ViewAction and ReducerAction type
    ///
    /// `Action` is generated by macro
    associatedtype Action: ActionProtocol<ViewAction, ReducerAction>
...
public protocol ActionProtocol<ViewAction, ReducerAction> {
    associatedtype ViewAction
